	...
	<?php else : ?>
		<div class="site-variations">
			...
			<?php foreach ( $attributes as $attribute_name => $options ) : ?>
				...
				<hr class="site-border">
			<?php endforeach; ?>
			<?php echo wp_kses_post( apply_filters( 'woocommerce_reset_variations_link', '<a class="reset_variations site-button" href="#" aria-label="' . esc_attr__( 'Clear options', 'woocommerce' ) . '">' . esc_html__( 'Clear', 'woocommerce' ) . '</a>' ) ); ?>
		</div>
		<table class="variations site-variations__native" cellspacing="0" role="presentation">
			<tbody>
				<?php foreach ( $attributes as $attribute_name => $options ) : ?>
					<tr>
