...
<div class="shopco-cart-page-body">
	<form class="woocommerce-cart-form" action="<?php echo esc_url( wc_get_cart_url() ); ?>" method="post">
		<?php do_action( 'woocommerce_before_cart_table' ); ?>

		<div class="shopco-cart cart woocommerce-cart-form__contents">
			<ul class="shopco-cart-list site-border">
				...
				foreach ( WC()->cart->get_cart() as $cart_item_key => $cart_item ) {
					...
					if ( $_product && $_product->exists() && $cart_item['quantity'] > 0 && apply_filters( 'woocommerce_cart_item_visible', true, $cart_item, $cart_item_key ) ) {
						...
						?>
						<li class="woocommerce-cart-form__cart-item shopco-cart-item <?php echo esc_attr( apply_filters( 'woocommerce_cart_item_class', 'cart_item', $cart_item, $cart_item_key ) ); ?>">
							...
							<div class="shopco-cart-item-details">
								...
								<div class="bottom">
									...
									<div class="product-quantity" data-title="<?php esc_attr_e( 'Quantity', 'woocommerce' ); ?>">
										...
										// phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- Trusted quantity input HTML generated by WooCommerce; wp_kses_post() would remove the input element.
	...
	<div class="cart-collaterals site-border">
		<?php
			/**
