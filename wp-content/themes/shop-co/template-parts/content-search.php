...
$shop_co_post_type_object = get_post_type_object( get_post_type() );
$shop_co_post_type_label  = $shop_co_post_type_object ? $shop_co_post_type_object->labels->singular_name : __( 'Content', 'shop-co' );
$shop_co_excerpt          = wp_trim_words( wp_strip_all_tags( get_the_excerpt() ), 22 );
?>
<article id="post-<?php the_ID(); ?>" <?php post_class( 'site-search-card' ); ?>>
	...
	<div class="site-search-card__content">
		<span class="site-search-card__type"><?php echo esc_html( $shop_co_post_type_label ); ?></span>
		<h2 class="site-search-card__title">
			<a href="<?php the_permalink(); ?>"><?php the_title(); ?></a>
		</h2>

		<?php if ( $shop_co_excerpt ) : ?>
			<p class="site-search-card__excerpt"><?php echo esc_html( $shop_co_excerpt ); ?></p>
		<?php endif; ?>
