					...
					<div class="site-footer__body-info">
						...
						<div class="site-footer__soc1als">
							<a class="site-footer__soc1als-link site-border" href="#" aria-label="<?php esc_attr_e( 'Twitter', 'shop-co' ); ?>">
								<img src="<?php echo esc_url( Shop_Co_Assets::asset( 'icons/socials/twitter.svg' ) ); ?>" width="11" height="9" alt="">
							</a>
							<a class="site-footer__soc1als-link site-border" href="#" aria-label="<?php esc_attr_e( 'Facebook', 'shop-co' ); ?>">
								<img src="<?php echo esc_url( Shop_Co_Assets::asset( 'icons/socials/fb.svg' ) ); ?>" width="6" height="12" alt="">
							</a>
							<a class="site-footer__soc1als-link site-border" href="#" aria-label="<?php esc_attr_e( 'Instagram', 'shop-co' ); ?>">
								<img src="<?php echo esc_url( Shop_Co_Assets::asset( 'icons/socials/insta.svg' ) ); ?>" width="14" height="14" alt="">
							</a>
							<a class="site-footer__soc1als-link site-border" href="#" aria-label="<?php esc_attr_e( 'GitHub', 'shop-co' ); ?>">
								<img src="<?php echo esc_url( Shop_Co_Assets::asset( 'icons/socials/gh.svg' ) ); ?>" width="13" height="13" alt="">
							</a>
						</div>
					</div>
					<nav class="site-footer__body-nav">
						<?php
						$shop_co_footer_menus = array(
						...
						foreach ( $shop_co_footer_menus as $shop_co_theme_location => $shop_co_menu_title ) :
							if ( ! has_nav_menu( $shop_co_theme_location ) ) {
								continue;
							}
							?>
							<div class="site-footer__menu-column">
								<h2 class="site-footer__menu-title"><?php echo esc_html( $shop_co_menu_title ); ?></h2>
								<?php
								wp_nav_menu(
									array(
										'theme_location' => $shop_co_theme_location,
										'container'      => false,
				...
				<div class="site-footer__body-bottom">
					...
					<div class="site-footer__pays pays">
						<div class="pays__badge">
							<img src="<?php echo esc_url( Shop_Co_Assets::asset( 'icons/pays/visa.svg' ) ); ?>" alt="" width="32.5" height="11.5" >
						</div>
						<div class="pays__badge">
							<img src="<?php echo esc_url( Shop_Co_Assets::asset( 'icons/pays/mastercard.svg' ) ); ?>" alt="" width="25.3" height="15.7" >
						</div>
						<div class="pays__badge">
							<img src="<?php echo esc_url( Shop_Co_Assets::asset( 'icons/pays/paypal.svg' ) ); ?>" alt="" width="34.5" height="9.2" >
						</div>
						<div class="pays__badge">
							<img src="<?php echo esc_url( Shop_Co_Assets::asset( 'icons/pays/apple-pay.svg' ) ); ?>" alt="" width="26.4" height="11.2" >
						</div>
						<div class="pays__badge">
							<img src="<?php echo esc_url( Shop_Co_Assets::asset( 'icons/pays/g-pay.svg' ) ); ?>" alt="" width="28.5" height="11.2" >
						</div>
					</div>
				</div>
			</div>
